#> nnsb_skill:skill/setting/main_skill_set/sinobi/skill_set_1
#スキルを確認させる。OMDのskill.unlockにある。

#nnsb: skill.archer_unlockに一度格納して流す。
  data modify storage nnsb: skill.unlock set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].skill.sinobi_unlock
