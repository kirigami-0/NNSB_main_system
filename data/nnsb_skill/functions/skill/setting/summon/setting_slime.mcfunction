...
#スライムを限定召喚する。
  execute at @e[tag=skill_setting_maker] run summon slime ^2.5 ^1.2 ^ {NoAI:true,Invulnerable:true,Size:0,Tags:[skill_setting_slime,main_skill_1],ActiveEffects:[{Id:14b,Duration:999999,ShowParticles:false},{Id:10b,Amplifier:5,Duration:999999,ShowParticles:false}],Silent:true,Glowing:true,Team:main_skill_1,Health:1024f,Attributes:[{Name:"generic.max_health",Base:1024}]}
  execute at @e[tag=skill_setting_maker] run summon slime ^1 ^1.2 ^ {NoAI:true,Invulnerable:true,Size:0,Tags:[skill_setting_slime,main_skill_2],ActiveEffects:[{Id:14b,Duration:999999,ShowParticles:false},{Id:10b,Amplifier:5,Duration:999999,ShowParticles:false}],Silent:true,Glowing:true,Team:main_skill_2,Health:1024f,Attributes:[{Name:"generic.max_health",Base:1024}]}
  execute at @e[tag=skill_setting_maker] run summon slime ^-1 ^1.2 ^ {NoAI:true,Invulnerable:true,Size:0,Tags:[skill_setting_slime,sub_skill_1],ActiveEffects:[{Id:14b,Duration:999999,ShowParticles:false},{Id:10b,Amplifier:5,Duration:999999,ShowParticles:false}],Silent:true,Glowing:true,Team:sub_skill_1,Health:1024f,Attributes:[{Name:"generic.max_health",Base:1024}]}
  execute at @e[tag=skill_setting_maker] run summon slime ^-2.5 ^1.2 ^ {NoAI:true,Invulnerable:true,Size:0,Tags:[skill_setting_slime,sub_skill_2],ActiveEffects:[{Id:14b,Duration:999999,ShowParticles:false},{Id:10b,Amplifier:5,Duration:999999,ShowParticles:false}],Silent:true,Glowing:true,Team:sub_skill_2,Health:1024f,Attributes:[{Name:"generic.max_health",Base:1024}]}
