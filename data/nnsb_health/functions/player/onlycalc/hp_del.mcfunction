<<<<<<< HEAD:data/nnsb_health/functions/player/remove.mcfunction
...
# nnsb_healthに減った後の体力をいれる。
scoreboard players operation @s nnsb_health = @s buffer_health_a
>>>>>>> a5a48f42d2dd9cdc734815a97f1f5da9013d975e:data/nnsb_health/functions/player/onlycalc/hp_del.mcfunction
