#> nnsb_health:damage/player_to_mobs/normal/15
#1.5倍ダメージ
...
#ダメージ倍率セット
  scoreboard players set &set_player_to_mob_damage_multiplier define 15
...
#進捗を再セット
  advancement revoke @s only nnsb_health:player_to_mobs/normal_damage_15
