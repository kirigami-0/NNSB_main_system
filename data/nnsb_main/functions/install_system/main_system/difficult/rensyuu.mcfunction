...
#会議開始の条件を満たしたとき
execute unless data storage difficult:game {difficulty:rensyuu} if data storage difficult:game {meeting_now:false} run schedule function nnsb_main:install_system/main_system/difficult/meeting_now 60s append
