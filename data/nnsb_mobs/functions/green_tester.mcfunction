...
#ゾンビを召喚する
summon zombie ~ ~ ~ {Silent:1b,Tags:[green],CustomNameVisible:1b,CustomName:'{"text":"ゾンビ","color":"green","bold":true}',Attributes:[{Name:"generic.knockback_resistance",Base:1},{Name:"generic.movement_speed",Base:-10}]}
